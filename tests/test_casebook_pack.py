"""Regression checks for the cinder-svc-queue-mesh casebook."""
...
from casebook.harness import assert_expected, cinder_svc_queue_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cinder_svc_queue_mesh_summary(), assert_expected())
